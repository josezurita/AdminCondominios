...
<title>Ingreso de Unidad Habitacional</title>
</head>
<body>
   <%@include file="cabecera.jsp" %>
    ...
    <div class="view">
	<h3 contenteditable="true" class="text-primary">Ingreso de Unidad Habitacional</h3>
	</div>
    ...
    <form  action="RegistrarUnidadH" method="post">
