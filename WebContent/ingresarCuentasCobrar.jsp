...
<title>Ingreso de Cuentas por cobrar</title>
</head>
<body>
   <%@include file="cabecera.jsp" %>
    ...
    <div class="view">
	<h3 contenteditable="true" class="text-primary">Ingreso de Cuentas por cobrar</h3>
	</div>
    
    <%
       //se cargan los datos del usuario que se va a editar
	   CuentasXCobrar cxc =(CuentasXCobrar) request.getAttribute("cuentaspagar");
       if (cxc==null){
    ...
    <form  action="RegistrarCXC" method="POST">
    ...
    <div class="form-group">
  	...
  	<div class="form-group">
     	<label for="fechaEmision">Mes</label>
    	<input type="text" class="form-control" name="txtMes" value="<%= cxc.getMes()%>"/>
 	</div>
 	<div class="form-group">
     	<label for="fechaEmision">Año</label>
    	<input type="text" class="form-control" name="txtAnio" value="<%= cxc.getAnio()%>"/>
 	</div>
 	
 	<div class="form-group">
     	<label for="fechaPago">Fecha de Pago</label>
    	<input type="text" class="form-control" name="txtFechaPago" value="<%= cxc.getFechaPago()%>"/>
 	</div> 	
     ...
     <div></div>
      <div class="form-group">
            <button type="submit" class="btn btn-primary">Crear Cuenta por Cobrar</button>
