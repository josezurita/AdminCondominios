 ...
 */
@WebServlet("/BuscarCuentasCobradas")
public class BuscarCuentasCobradas extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuscarCuentasCobradas() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String txtCuentaCobrarBusqueda = request.getParameter("txtCuentaCobrarBusqueda");
			...
			List<ServicioCXC> cuentascobrar = cxp.consultarCuentasCobrarTrue(txtCuentaCobrarBusqueda);
			request.setAttribute("cuentascobrar", cuentascobrar);
			RequestDispatcher rd = request.getRequestDispatcher("adminIngresos.jsp");
